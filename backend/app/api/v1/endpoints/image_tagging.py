...
from app.services.image.tagging.handler import ImageTaggingHandler
from app.schemas.image_tagging import (
    ImageTagAdd,
    ImageTagUpdate,
    ImageTagDelete,
    BatchImageTagOperation,
)
from app.schemas.common import StandardResponse

router = APIRouter(tags=["图片标签操作"])
...
async def get_image_tags(
    ...
    # 使用业务处理器处理标签获取逻辑
    handler = ImageTaggingHandler(db)
